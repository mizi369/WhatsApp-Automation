...
export default function Payroll({ showToast }: { showToast: any }) {
  ...
  useEffect(() => {
    if (location.state?.autoOpen && employees.length > 0) {
      ...
      setFormData({
        ...
        epf_employee: calcs.epfEmp,
        epf_employer: calcs.epfMjr,
        socso_employee: calcs.socsoEmp,
        socso_employer: calcs.socsoMjr,
        advance: 0
      });
  ...
  const handleManualEdit = (field: string, value: any) => {
    ...
    if (field === 'basic_salary' || field === 'advance' || field === 'is_part_time') {
      const emp = employees.find(e => e.name === newFormData.employee_name);
      const calcs = calculatePayroll(
        newFormData.basic_salary, 
        newFormData.advance, 
        newFormData.is_part_time,
  ...
  const netSalary = formData.basic_salary - formData.epf_employee - formData.socso_employee - formData.advance;

  const handleSave = async (e: React.FormEvent) => {
    e.preventDefault();
    const [m, y] = formData.month_year.split(' ');
    const newEntry = {
      ...
      epf_employer: formData.epf_employer,
      socso_employee: formData.socso_employee,
      socso_employer: formData.socso_employer,
      advance: formData.advance,
      net: netSalary,
      type: formData.is_part_time ? 'Part-time' : 'Full-time',
    ...
    if (!error) {
      ...
      await db.insert(TABLES.TRANSACTIONS, {
        ...
        description: `Gaji: ${formData.employee_name} (${formData.month_year})`,
        source: 'Payroll'
      });
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <input 
                        ...
                        onChange={(e) => handleManualEdit('basic_salary', parseFloat(e.target.value))}
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1">
                        ...
                        <input 
                          ...
                          onChange={(e) => handleManualEdit('month_year', e.target.value)}
                        />
                      </div>
                      <div className="space-y-1">
                    ...
                    <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl border border-gray-200">
                      <input 
                        ...
                        onChange={(e) => handleManualEdit('is_part_time', e.target.checked)}
                  ...
                  <div className="space-y-4 bg-gray-50 p-4 rounded-2xl border border-gray-200">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1">
                        ...
                        <input 
                          type="number" 
                          disabled={formData.is_part_time}
                          ...
                          onChange={(e) => handleManualEdit('epf_employee', parseFloat(e.target.value))}
                        />
                      </div>
                      <div className="space-y-1">
                        ...
                        <input 
                          ...
                          onChange={(e) => handleManualEdit('epf_employer', parseFloat(e.target.value))}
                        />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1">
                        ...
                        <input 
                          ...
                          disabled={formData.is_part_time}
                          className="w-full bg-white border border-gray-200 rounded-xl px-4 py-2 text-sm text-gray-900 focus:border-secondary focus:ring-1 focus:ring-secondary outline-none disabled:opacity-50 disabled:bg-gray-100"
                          value={formData.socso_employee}
                          onChange={(e) => handleManualEdit('socso_employee', parseFloat(e.target.value))}
                        />
                      </div>
                      <div className="space-y-1">
                        ...
                        <input 
                          ...
                          disabled={formData.is_part_time}
                          className="w-full bg-white border border-gray-200 rounded-xl px-4 py-2 text-sm text-gray-900 focus:border-secondary focus:ring-1 focus:ring-secondary outline-none disabled:opacity-50 disabled:bg-gray-100"
                          value={formData.socso_employer}
                          onChange={(e) => handleManualEdit('socso_employer', parseFloat(e.target.value))}
                        />
                      </div>
                    </div>
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-sm font-bold text-gray-900">RM {(formData.basic_salary || 0).toFixed(2)}</span>
                      </div>
                ...
                <div className="grid grid-cols-2 gap-6 p-4 bg-gray-50 rounded-2xl border border-gray-200">
                  <div className="space-y-1">
                    ...
                    <div className="flex gap-2">
                      <button 
                        type="button"
                        onClick={() => handleManualEdit('payment_type', 'Debit')}
                        className={`flex-1 flex items-center justify-center gap-2 py-2 rounded-xl text-xs font-bold transition-all border ${formData.payment_type === 'Debit' ? 'bg-secondary text-white border-secondary shadow-md' : 'bg-white border-gray-200 text-gray-500 hover:bg-gray-50'}`}
                      >
                        <CreditCard size={14} /> Debit
                      </button>
                      <button 
                        type="button"
                        onClick={() => handleManualEdit('payment_type', 'Credit')}
                        className={`flex-1 flex items-center justify-center gap-2 py-2 rounded-xl text-xs font-bold transition-all border ${formData.payment_type === 'Credit' ? 'bg-secondary text-white border-secondary shadow-md' : 'bg-white border-gray-200 text-gray-500 hover:bg-gray-50'}`}
                      >
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex gap-2">
                      <button 
                        type="button"
                        onClick={() => handleManualEdit('payment_method', 'Tunai')}
                        className={`flex-1 flex items-center justify-center gap-2 py-2 rounded-xl text-xs font-bold transition-all border ${formData.payment_method === 'Tunai' ? 'bg-primary text-white border-primary shadow-md' : 'bg-white border-gray-200 text-gray-500 hover:bg-gray-50'}`}
                      >
                        <Banknote size={14} /> Tunai
                      </button>
                      <button 
                        type="button"
                        onClick={() => handleManualEdit('payment_method', 'Transfer')}
                        className={`flex-1 flex items-center justify-center gap-2 py-2 rounded-xl text-xs font-bold transition-all border ${formData.payment_method === 'Transfer' ? 'bg-primary text-white border-primary shadow-md' : 'bg-white border-gray-200 text-gray-500 hover:bg-gray-50'}`}
                      >
